    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content" id="deletecon_m">
        ...
        <div class="modal-footer">
          <button type="button" id="deleteb_m" class="yes"
            data-dismiss="modal" name="">삭제</button>
          <button type="reset" id="deleteb_m" class="no"
            data-dismiss="modal" name="">취소</button>
        </div>
      </div>
    </div>
  </div>
        ...
        <section class="content">
          <div class="container">
            <div class="row">
              ...
              <form
                action="${pageContext.servletContext.contextPath}/boards/updateaction.joya?articleid=${article.articleId}&boardid=2"
                method="post">
                <div id="ji-tableM">
                  <%-- 게시글 상세읽기 테이블 --%>
                  <table>
