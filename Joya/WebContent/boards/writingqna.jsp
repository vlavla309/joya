...
<script type="text/javascript">
	...
	$(function(){
		$(".btn").on("click", function(){
			$.ajax({
				url: "${pageContext.servletContext.contextPath}/board/qna.joya",
				method : "post",
				sucess : function(){
					alert("ㅊㅋㅊㅋ");
				}
            ...
            <div class="group-contact clearfix">
              <div class="container">
                <div class="row">
                 ...
                 <form action="${pageContext.servletContext.contextPath}/boards/qnawrite.joya" method="post">
                      ...
                      <input type="hidden" value="${email}" name="email">  
                           ...
                           <div>
                            <div class="midivision left-block col-md-12">
                              <label class="control-label" for="email">이름
                                ...
                                class="form-control email"   name="writer" readonly="readonly">
                            </div>
                          </c:when>
                          <c:otherwise>
                           <div>
                        ...
                        <div class="midivision1 col-md-12">
                          <label class="control-label" for="name" >비밀번호<span
                            ...
                            name="passwd" pattern="[0-9]{4}" required placeholder="비밀번호(숫자0~9까지 4자리)">
                        </div>
                      </div>
