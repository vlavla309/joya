				...
				<li class="customer-links hidden-xs">
					<ul id="accounts" class="list-inline">
						...
						<li class="login">    
							...
							<form method="post" action="#" id="customer_login" accept-charset="UTF-8"><input type="hidden" value="customer_login" name="form_type"><input type="hidden" name="utf8" value="â">
								<div id="bodyBox">
					...
					<div itemprop="breadcrumb" class="container">
						<div class="row">
							<div class="col-md-24">
								...
								<span>/</span>
								<span class="page-title">QnA - Writing</span>
							</div>
						</div>
					</div>
				</div>               
									...
									if(jQuery().gMap){
										if($('#contact_map').length){
										  $('#contact_map').gMap({
											...
											markers:[
											  {
												address: '249 Ung VÄn KhiÃªm, phÆ°á»ng 25, Ho Chi Minh City, Vietnam',
												html: '_address'
											  }
											]
										  });
