				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<select name="type" id="selectType">
							...
							<option value="orderer">이름</option>
						</select>
							...
							<table width="100%"
								...
								<tbody>
									<c:forEach items="${orders}" var="order" varStatus="status">
										<tr class="odd gradeX">
											<td><a class="userInfoBtn" value="${order.orderId }">${order.orderId }</a></td>
											<td>${order.email }</td>
											<td class="center">${order.orderer }</td>
	...
	<script>
		$(function(){
			$("#selectStatus").change(function(){
				location.href="/admin/orders.joya?status="+$(this).val()
			})
		})
