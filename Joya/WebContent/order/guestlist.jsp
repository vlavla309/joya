                ...
                <div id="customer_orders">
                  ...
                  <div class="row wrap-table">
                    ...
                    <tbody>
	                    <tr class="odd ">
	                      <td>
	                        <a href="/mypage/orderdetail.joya?orderid=${orders.orderId}&status=${orders.status}" title="">${orders.orderId}</a>
	                      </td>
	                      <td>
	                        <a href="/mypage/orderdetail.joya?orderid=${orders.orderId}&status=${orders.status}" title=""><span class="note"> ${orders.orderDate}</span></a>
	                      </td>
	                      <td>
	                        <a href="/mypage/orderdetail.joya?orderid=${orders.orderId}&status=${orders.status}" title=""><span class="status_authorized">${orders.paymentType}</span></a>
	                      </td>
	                      <td>
	                        <span class="status_unfulfilled">${orders.status}</span>
	                      </td>
	                      <td>
	                        <span class="total">${orders.usedPoint}</span>
	                      </td>
	                      <td>
	                        <span class="total">${orders.payment}</span>
	                      </td>
	                    </tr>
                    </tbody>
                    <!-- 테이블 바디 종료 -->
