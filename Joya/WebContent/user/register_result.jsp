							...
							<div id="col-main" class="col-md-24 register-page clearfix">
								 <div class="thanks-bg">
                                   ...
                                   <div class="thanks-text" >
                                    ...
                                    <div id="ji-userInfo">
                                       <span class="wow fadeIn"><strong class="kind">이메일</strong> surinim@naver.com</span><br>
                                       <span class="wow fadeIn"><strong class="kind">이름</strong> 정지현</span><br>
                                       <span class="wow fadeIn"><strong class="kind">전화번호</strong> 010-0000-0000</span><br>
                                     </div>
