      ...
      <div id="content" class="clearfix">
        ...
        <section class="content">
          ...
          <div class="container">
            <div class="row">
              <div id="col-main"
                class="account-page col-sm-18 col-md-18 clearfix">
                <div id="customer_orders">
                  <h6 class="sb-title">Review</h6>
                  <span class="mini-line"></span>
                  <div class="row wrap-table">
                    <form
                      action="${pageContext.servletContext.contextPath}/boards/writearticle.joya?board_id=3"
                      ...
                      <table class="table-hover">
                        ...
                        <thead>
                          <tr>
                            <th class="order_number" id="mi_review_1"> File</th>
                            <th class="payment_status" colspan="4" id="mi_review_2">Please Write Your Comment</th>
                          </tr>
                        </thead>
                        <!-- 테이블 헤더 종료 -->
                        ...
                        <tbody>
                          <tr class="odd ">
                            <td id=""><a href="order_detail.jsp" title=""><img src="../boards/asimages/join.png"></a></td>
                            <td colspan="4"><textarea rows="10" cols="80" name="contents" id="m_reviewtxt"></textarea></td>
                          </tr>
                        </tbody>
                        <!-- 테이블 바디 종료 -->
                      </table>
