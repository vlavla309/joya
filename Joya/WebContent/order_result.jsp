                         ...
                         <br>
                            <div class="thanks-img wow fadeIn"><img src="../assets/images/order_complete.png" alt="" title="" class="img-responsive"></div><br>
                              <div class="thanks-text" >
                                ...
                                <br> 
                                <div id="ji-userInfo">
                                  <span class="wow fadeIn"><strong class="kind">주문번호</strong>${user.email }</span><br>
                                  <span class="wow fadeIn"><strong class="kind">배송지 정보</strong>${user.name }</span><br>
                                  <span class="wow fadeIn"><strong class="kind">결제 정보</strong>${user.name }</span><br>
                                  <span class="wow fadeIn"><strong class="kind">결제 금액</strong>${user.phone }</span><br>
                                </div>
                                <br>
